...
/*
What changed vs v2:
- Use Service.state and Service.status as PROPERTIES (not methods).
- subscribe(listener) returns a FUNCTION (unsubscribe), not {unsubscribe}.
- Tests that used to rely on synchronous pre-notify now avoid timing dependencies.
*/
...
function T_REQ_ESP_01() {
  ...
  var ok = (typeof s.start==="function" &&
            ...
            typeof s.state==="object"); // updated: state is a property
...
function T_REQ_REV_01() {
  // Status enum presence. JS reference exposes numeric status.
...
function T_REQ_REV_09() { return T_REQ_FSM_13(); } // subscribe semantics (return fn + unsubscribe effectiveness)
